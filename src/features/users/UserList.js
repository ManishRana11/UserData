  ...
  const renderCard = () => users.map(user => (
    <div className="bg-gray-300 p-5 flex items-center justify-between" key={user.id}>
      <div>
        ...
        <h3 className="font-normal text-gray-600">{user.lastname}</h3>
        <br/>
        <h3 className="font-normal text-gray-600">{user.group}</h3>
        <br/>
        <h3 className="font-normal text-gray-600">{user.permissions}</h3>
      </div>
